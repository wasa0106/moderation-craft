...
export const queryKeys = {
  ...
  bigTasksByProject: (projectId: string) => [...queryKeys.bigTasks(), 'project', projectId] as const,
  ...
  smallTasksByBigTask: (bigTaskId: string) => [...queryKeys.smallTasks(), 'big-task', bigTaskId] as const,
  ...
  activeSessionForUser: (userId: string) => [...queryKeys.workSessions(), 'active', userId] as const,
...
export const invalidateQueries = {
  ...
  projectsByUser: (userId: string) => queryClient.invalidateQueries({ queryKey: queryKeys.projectsByUser(userId) }),
  ...
  workSession: (id: string) => queryClient.invalidateQueries({ queryKey: queryKeys.workSession(id) }),
